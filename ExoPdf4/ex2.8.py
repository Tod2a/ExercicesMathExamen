...
#----------------------------------------------------------------------#
#                                                                      #
#      ouvre une image et crée une image avec la luminosité modifiée   #
#                                                                      #         
#                                                                      #
#----------------------------------------------------------------------#
...
print("\nDiminution de la luminosité d'une image avec numpy et PIL\n")
print("\n---------------------------------------------\n")

start = time.time()

img_out = np.where(image<30, 0, image-30)

end = time.time()

print("\nvous avez diminué la luminosité de l'image", img ," de 30, l'opération vous a prit: ", end-start, " secondes")
