...
#----------------------------------------------------------------------#
#                                                                      #
#         ouvre une image et crée une image en nuance de gris          #
#                                                                      #         
#                                                                      #
#----------------------------------------------------------------------#
...
print("\nNuance de gris d'une image avec numpy et PIL\n")
print("\n---------------------------------------------\n")
...
for ligne in range(nb_lignes):
    for col in range(nb_colonnes):
        lum = 0.2121 * image[ligne, col, 0] + 0.7152 * image[ligne, col, 1] + 0.0722 * image[ligne, col, 2]
        img_out[ligne, col] = [lum, lum, lum]

end = time.time()

print("\nvous avez nuancé de gris l'image", img ,", l'opération vous a prit: ", end-start, " secondes")
