...
#----------------------------------------------------------------------#
#                                                                      #
#    ouvre une image et crée une image redimensionnée de cette image   #
#                                                                      #         
#                                                                      #
#----------------------------------------------------------------------#
...
print("\nRedimension d'une image avec numpy et PIL\n")
print("\n---------------------------------------------\n")

start = time.time()

img_out = np.zeros((220,220,3), dtype=np.uint8)
for ligne in range(newnb_lignes):
    for col in range(newnb_colonnes):
        img_out[ligne, col] = image[int(ligne*ratio), int(col*ratio)]

end = time.time()

print("\nvous avez redimenssioné l'image", img ,", l'opération vous a prit: ", end-start, " secondes")
