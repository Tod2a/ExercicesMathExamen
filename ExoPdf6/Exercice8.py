...
#----------------------------------------------------------------------#
#                                                                      #
#                    utilisation d'un filtre de piqué                  #
#                                                                      #  
#                                                                      #
#----------------------------------------------------------------------#
...
print("\nFiltre de piqué de Lenna avec un masque 3x3\n")
print("\n---------------------------------------------\n")
...
print(f"\nLe filtre de piqué de Lenna est réussi, l'opération vous a pris: {end-start} secondes")
